...
The ConferencePayment content type
===============================

In this section we are tesing the ConferencePayment content type by performing
basic operations like adding, updadating and deleting ConferencePayment content
items.

Adding a new ConferencePayment content item
--------------------------------
...
'ConferencePayment' and click the 'Add' button to get to the add form.

    >>> browser.getControl('ConferencePayment').click()
    >>> browser.getControl(name='form.button.Add').click()
    >>> 'ConferencePayment' in browser.contents
    True

Now we fill the form and submit it.

    >>> browser.getControl(name='title').value = 'ConferencePayment Sample'
    >>> browser.getControl('Save').click()
    >>> 'Changes saved' in browser.contents
    True

And we are done! We added a new 'ConferencePayment' content item to the portal.

Updating an existing ConferencePayment content item
---------------------------------------

Let's click on the 'edit' tab and update the object attribute values.

    >>> browser.getLink('Edit').click()
    >>> browser.getControl(name='title').value = 'New ConferencePayment Sample'
    >>> browser.getControl('Save').click()
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'New ConferencePayment Sample' in browser.contents
    True

Removing a/an ConferencePayment content item
--------------------------------

If we go to the home page, we can see a tab with the 'New ConferencePayment
...
Now we are going to delete the 'New ConferencePayment Sample' object. First we
go to the contents tab and select the 'New ConferencePayment Sample' for
deletion.

    >>> browser.getLink('Contents').click()
    >>> browser.getControl('New ConferencePayment Sample').click()
...
So, if we go back to the home page, there is no longer a 'New ConferencePayment
Sample' tab.
...
Adding a new ConferencePayment content item as contributor
------------------------------------------------

Not only site managers are allowed to add ConferencePayment content items, but
...
We select 'ConferencePayment' and click the 'Add' button to get to the add form.
...
Done! We added a new ConferencePayment content item logged in as contributor.
