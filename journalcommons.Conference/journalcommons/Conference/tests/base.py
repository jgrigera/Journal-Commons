...
def setup_product():
    ...
    import journalcommons.Conference
    zcml.load_config('configure.zcml', journalcommons.Conference)
    ...
    ztc.installPackage('journalcommons.Conference')
...
setup_product()
ptc.setupPloneSite(products=['journalcommons.Conference'])
