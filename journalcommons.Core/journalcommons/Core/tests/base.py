...
def setup_product():
    ...
    import journalcommons.Core
    zcml.load_config('configure.zcml', journalcommons.Core)
    ...
    ztc.installPackage('journalcommons.Core')
...
setup_product()
ptc.setupPloneSite(products=['journalcommons.Core'])
