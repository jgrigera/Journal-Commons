...
from gcommons.Journal.portlets import articlelistportlet
from gcommons.Journal.portlets.tests.base_articlelistportlet import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(IPortletType, name='gcommons.Journal.portlets.ArticleListPortlet')
        self.assertEquals(portlet.addview, 'gcommons.Journal.portlets.ArticleListPortlet')
