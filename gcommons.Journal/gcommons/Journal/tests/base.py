...
def setup_product():
    ...
    import gcommons.Journal
    zcml.load_config('configure.zcml', gcommons.Journal)
    ...
    ztc.installPackage('gcommons.Journal')
...
setup_product()
ptc.setupPloneSite(products=['gcommons.Journal'])
