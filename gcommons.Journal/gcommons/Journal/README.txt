...
The gcFrontPage content type
===============================

In this section we are tesing the gcFrontPage content type by performing
basic operations like adding, updadating and deleting gcFrontPage content
items.

Adding a new gcFrontPage content item
--------------------------------
...
'gcFrontPage' and click the 'Add' button to get to the add form.

    >>> browser.getControl('gcFrontPage').click()
    >>> browser.getControl(name='form.button.Add').click()
    >>> 'gcFrontPage' in browser.contents
    True

Now we fill the form and submit it.

    >>> browser.getControl(name='title').value = 'gcFrontPage Sample'
    >>> browser.getControl('Save').click()
    >>> 'Changes saved' in browser.contents
    True

And we are done! We added a new 'gcFrontPage' content item to the portal.

Updating an existing gcFrontPage content item
---------------------------------------

Let's click on the 'edit' tab and update the object attribute values.

    >>> browser.getLink('Edit').click()
    >>> browser.getControl(name='title').value = 'New gcFrontPage Sample'
    >>> browser.getControl('Save').click()
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'New gcFrontPage Sample' in browser.contents
    True

Removing a/an gcFrontPage content item
--------------------------------

If we go to the home page, we can see a tab with the 'New gcFrontPage
...
Now we are going to delete the 'New gcFrontPage Sample' object. First we
go to the contents tab and select the 'New gcFrontPage Sample' for
deletion.

    >>> browser.getLink('Contents').click()
    >>> browser.getControl('New gcFrontPage Sample').click()
...
So, if we go back to the home page, there is no longer a 'New gcFrontPage
Sample' tab.
...
Adding a new gcFrontPage content item as contributor
------------------------------------------------

Not only site managers are allowed to add gcFrontPage content items, but
...
We select 'gcFrontPage' and click the 'Add' button to get to the add form.
...
Done! We added a new gcFrontPage content item logged in as contributor.
