...
def setup_product():
    ...
    import journalcommons.Utils
    zcml.load_config('configure.zcml', journalcommons.Utils)
    ...
    ztc.installPackage('journalcommons.Utils')
...
setup_product()
ptc.setupPloneSite(products=['journalcommons.Utils'])
