...
# I am only adding roles=Author, but simply copying from Plone. Bad thing...
...
try:
    portal_registration.addMember(username, password, roles=('JournalAuthor',), properties=REQUEST, REQUEST=context.REQUEST)
