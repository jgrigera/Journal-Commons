...
def setup_product():
    ...
    import journalcommons.Journal
    zcml.load_config('configure.zcml', journalcommons.Journal)
    ...
    ztc.installPackage('journalcommons.Journal')
...
setup_product()
ptc.setupPloneSite(products=['journalcommons.Journal'])
