...
The ResearchThread content type
===============================

In this section we are tesing the ResearchThread content type by performing
basic operations like adding, updadating and deleting ResearchThread content
items.

Adding a new ResearchThread content item
--------------------------------
...
'ResearchThread' and click the 'Add' button to get to the add form.

    >>> browser.getControl('ResearchThread').click()
    >>> browser.getControl(name='form.button.Add').click()
    >>> 'ResearchThread' in browser.contents
    True

Now we fill the form and submit it.

    >>> browser.getControl(name='title').value = 'ResearchThread Sample'
    >>> browser.getControl('Save').click()
    >>> 'Changes saved' in browser.contents
    True

And we are done! We added a new 'ResearchThread' content item to the portal.

Updating an existing ResearchThread content item
---------------------------------------

Let's click on the 'edit' tab and update the object attribute values.

    >>> browser.getLink('Edit').click()
    >>> browser.getControl(name='title').value = 'New ResearchThread Sample'
    >>> browser.getControl('Save').click()
...
We check that the changes were applied.
    ...
    >>> 'Changes saved' in browser.contents
    True
    >>> 'New ResearchThread Sample' in browser.contents
    True

Removing a/an ResearchThread content item
--------------------------------

If we go to the home page, we can see a tab with the 'New ResearchThread
...
Now we are going to delete the 'New ResearchThread Sample' object. First we
go to the contents tab and select the 'New ResearchThread Sample' for
deletion.

    >>> browser.getLink('Contents').click()
    >>> browser.getControl('New ResearchThread Sample').click()
...
So, if we go back to the home page, there is no longer a 'New ResearchThread
Sample' tab.
...
Adding a new ResearchThread content item as contributor
------------------------------------------------

Not only site managers are allowed to add ResearchThread content items, but
...
We select 'ResearchThread' and click the 'Add' button to get to the add form.
...
Done! We added a new ResearchThread content item logged in as contributor.
